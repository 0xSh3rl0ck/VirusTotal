...
# check if the hash is malicious or not !
    ...
    if response_json['positives'] <= 0:
        ...
        print("The Hash May Be Malicious ! ")
...
# Check The Domain .
    ...
    result = response_json['undetected_downloaded_samples']
    list = []
    for line in result:
    ...
    elif 1 >= final_result >= 3:
        print("The Domain May Be Malicious ! ")
...
# Check The Url .
    ...
    if response_json['positives'] <= 0:
        ...
        print("The Url May Be Malicious ! ")
...
# Check The Ip-Address
    ...
    if final_result <= 0:
        ...
        print("The Ip-Address May Be Malicious ! ")
